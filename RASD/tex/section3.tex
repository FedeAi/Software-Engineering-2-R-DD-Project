...
\begin{enumerate}[label=\textbf{-G\arabic*}:]
    \item {Allow customers to obtain information about nearby charging stations
          \begin{itemize}
              \item \textbf{R1:} The system allows customers to log-in.
              \item \textbf{R2:} The system allows customers to view nearby station.
              \item \textbf{R3:} The system allows customer to select a charging station to view its information.
    ...
    \item {Allow customers to book a charge for a certain timeframe
          \begin{itemize}
              \item \textbf{R1:} The system allows customers to log-in.
              \item \textbf{R2:} The system allows customers to view nearby station.  
              \item\textbf{R3:} The system allows customers to select a charging station to view its information.
              \item \textbf{R4:} The system shows available socket for each charging station.
              \item \textbf{R5:} The system allows customer to book an available socket in a charging station.
              \item \textbf{D1:} Each customer who wants to use eMall needs to have a mobile device with the most common mobile OSes (e.g. iOS, Android), and also a reliable Internet connection with that device.
              \item \textbf{D4:} The customer's schedule and location is accessible by the platform.
    ...
    \item {Allow customers to start the charge and show predicted charging time
          \begin{itemize}
              \item \textbf{R1:} The system allows customers to log-in.
              \item \textbf{R6:} The system allows customers to view personal bookings.
              \item \textbf{R7:} The system allows customers to select a specific booking.
              \item \textbf{R8:} The system allows to start a charge for a booking when the vehicle is connected and ready to charge.
              \item \textbf{R9:} The system shows to the user the predicted charging time when the charge is started.
              \item \textbf{D1:} Each customer who wants to use eMall needs to have a mobile device with the most common mobile OSes (e.g. iOS, Android), and also a reliable Internet connection with that device.
    ...
    \item {Allow customers to know when the charging has finished
          \begin{itemize}
              \item \textbf{R1:} The system allows customers to log-in.
              \item \textbf{R10:} The system show the binary charging state (in charge/finished).
              \item \textbf{R11:} The system recommends alternative day/time slots or store/chains to a user.
              \item \textbf{D1:} Each customer who wants to use eMall needs to have a mobile device with the most common mobile OSes (e.g. iOS, Android), and also a reliable Internet connection with that device.
...
\begin{table}[H]
    ...
    1. Sign Up Customer                                         & *******                                                   &  \\ \cline{1-2}
    2. Login Customer on the application                        & R1                                                        &  \\ \cline{1-2}
    3. Book a Charge                                            & R1, R2, R3, R4, R5                                        &  \\ \cline{1-2}
    4. Remotely Start a Charge                                  & R1, R6, R7, R8, R9                                        &  \\  \cline{1-2}
    5. Pay for the Charging Service                             & R1, R6, R7, R12                                           &  \\ \cline{1-2}
    6. View Suggestions                                         & R1, R13,R14                                               &  \\ \cline{1-2}
    7. CPO Login                                                & R15                                                       &  \\ \cline{1-2}
    8. Select a DSO option                                      & R15, R16, R17, R19                                        &  \\ \cline{1-2}
